...
let appConfig = {
    ...
    tabs: [
        { name: '中文字幕',     ext: { url: 'https://belt.cwzoisnd.xyz/theme/detail/3/' } },
        { name: '最近更新',     ext: { url: 'https://belt.cwzoisnd.xyz/new/' } },
        { name: '新作上市',     ext: { url: 'https://belt.cwzoisnd.xyz/release/' } },
        { name: '本周热门',     ext: { url: 'https://belt.cwzoisnd.xyz/popular/week/' } },
        { name: '今日热门',     ext: { url: 'https://belt.cwzoisnd.xyz/popular/today/' } },
        { name: '无码高清',     ext: { url: 'https://belt.cwzoisnd.xyz/theme/detail/11/update/' } },
        { name: 'FC2',          ext: { url: 'https://belt.cwzoisnd.xyz/tags/3445/latest/' } },
        { name: 'LUXU',         ext: { url: 'https://belt.cwzoisnd.xyz/tags/3528/latest/' } },
        { name: 'GANA',         ext: { url: 'https://belt.cwzoisnd.xyz/tags/3529/latest/' } },
        { name: 'SIRO',         ext: { url: 'https://belt.cwzoisnd.xyz/tags/3527/' } },
        { name: 'HEYZO',        ext: { url: 'https://belt.cwzoisnd.xyz/tags/3532/latest/' } },
        { name: '网黄精选',     ext: { url: 'https://belt.cwzoisnd.xyz/theme/detail/17/update/' } },
        { name: '熟女',         ext: { url: 'https://belt.cwzoisnd.xyz/tags/169/latest/' } },
        { name: '黑丝',         ext: { url: 'https://belt.cwzoisnd.xyz/tags/142/latest/' } },
        { name: '乱伦',         ext: { url: 'https://belt.cwzoisnd.xyz/tags/673/latest/' } },
        { name: '巨乳',         ext: { url: 'https://belt.cwzoisnd.xyz/tags/170/latest/' } },
        { name: '波多野结衣',   ext: { url: 'https://belt.cwzoisnd.xyz/actress/detail/3080/latest/' } },
    ],
}
